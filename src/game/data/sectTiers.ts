// 宗門分級制度(1.8 版新增,1.9 版調高門檻並改為素材/貢獻並行)
// 五大門派各自累積「貢獻靈石」(存入即歸宗門所有,不可取回,唯一用途是晉升宗門等級)以及
// 「宗門倉庫」中須備妥的各地素材(採集靈材、獵殺妖獸取得),兩者皆達標方可晉升,
...
export interface SectTierDef {
  ...
  materials?: { id: string; n: number }[]; // 晉升本階時,宗門倉庫須備妥並消耗的各地素材
