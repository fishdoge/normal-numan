...
// 3.14 版:hp/atk 隨符寶威力(techniques.ts)同步下修。原本 hp 從 14 一路指數長到 600 億,
// 疊加符寶舊制 power 同樣指數長到 300,兩條指數曲線相乘,後期戰鬥只剩「數值輾壓」。這次改成單一
// 連續的對數內插壓縮:hp 每提高一個數量級,壓縮倍率平滑增加(池底 1x、頂端約 45x),同時套用在
// hp 與 atk 兩側以維持原有的相對「幾回合能打贏」節奏,不再是舊版那樣只對 hp≤500 萬的怪物打折、
// 其餘上億甚至上百億 hp 的極端怪完全不動的暫時性做法。蠻荒四大地域王之中「霸下」刻意保留遠高於
// 同儕的 hp(其描述本就設定為「尋常妖獸的四十倍」),壓縮後仍維持這個相對倍率,屬於敘事上的刻意
// 例外,不是遺漏。
export const MONSTERS: Monster[] = [
  ...
  { id: "qinglang", name: "青背狼", element: "木", hp: 18, atk: 3, exp: 6, stones: [1, 3], drops: [{ id: "qingmu", chance: 0.2 }, { id: "yaodan", chance: 0.1 }], desc: "背生青毛的狼型妖獸,行動迅捷。" },
  { id: "tiejiachong", name: "鐵甲蟲群", element: "金", hp: 20, atk: 3, exp: 8, stones: [1, 4], drops: [{ id: "tiekuang", chance: 0.5 }], desc: "甲殼堅硬如鐵的蟲群,尋常法術難傷。" },
  { id: "hanshuimang", name: "寒水蟒", element: "水", hp: 26, atk: 3, exp: 14, stones: [3, 6], drops: [{ id: "hanjing", chance: 0.3 }, { id: "yaodan", chance: 0.2 }], desc: "潛伏寒潭的巨蟒,吐息成冰。" },
  { id: "huomang", name: "赤炎火蟒", element: "火", hp: 30, atk: 3, exp: 21, stones: [4, 9], drops: [{ id: "huoyu", chance: 0.45 }, { id: "yaodan", chance: 0.25 }], desc: "周身赤鱗燃焰的火蟒,一階頂級妖獸。" },
  { id: "shiyan", name: "石岩傀儡", element: "土", hp: 37, atk: 4, exp: 29, stones: [5, 12], drops: [{ id: "wenyu", chance: 0.35 }], desc: "上古修士遺留的土石傀儡,力大無窮。" },
  { id: "yinhun", name: "陰魂老怪", element: "水", hp: 42, atk: 4, exp: 42, stones: [8, 16], drops: [{ id: "yinsha", chance: 0.5 }, { id: "m_hanbing", chance: 0.02 }], desc: "洞窟深處的陰魂,怨氣沖天,懼火克金。" },
  { id: "leizhujing", name: "金雷竹精", element: "金", hp: 49, atk: 5, exp: 62, stones: [10, 23], drops: [{ id: "jinleizhu", chance: 0.6 }, { id: "m_leidun", chance: 0.02 }], desc: "吸收雷霆成精的金雷竹,周身電光繚繞。" },
  { id: "cuiyunyan", name: "翠雲燕", element: "木", hp: 17, atk: 2, exp: 5, stones: [1, 3], drops: [{ id: "qingmu", chance: 0.25 }, { id: "huanglongcao", chance: 0.2 }], desc: "羽翼翠綠如雲的靈燕,掠地成風,難以捕捉。" },
  { id: "duyanchan", name: "毒眼蟾", element: "水", hp: 34, atk: 4, exp: 25, stones: [4, 10], drops: [{ id: "yaodan", chance: 0.3 }, { id: "yinsha", chance: 0.2 }], desc: "獨目巨蟾,口吐毒霧,潛伏於沼澤陰處。" },
  { id: "huoyanju", name: "火鬃巨犀", element: "火", hp: 47, atk: 5, exp: 55, stones: [9, 20], drops: [{ id: "huoyu", chance: 0.4 }, { id: "wenyu", chance: 0.25 }], desc: "鬃毛燃燒不熄的巨犀,一撞裂石開山。" },
  // ── 血色禁地(結丹級) ──
  { id: "xuejiao", name: "血蛟", element: "水", hp: 112, atk: 13, exp: 220, stones: [36, 84], drops: [{ id: "jiaolin", chance: 0.6 }, { id: "m_qingzhufeng", chance: 0.02 }, { id: "xueyu", chance: 0.15 }], desc: "欲化龍而未成的血色蛟龍,盤踞禁地血河。" },
  { id: "shengui", name: "禁地石龜", element: "土", hp: 162, atk: 13, exp: 310, stones: [48, 110], drops: [{ id: "wenyu", chance: 0.7 }, { id: "qiannianlingru", chance: 0.3 }], desc: "馱著半座山的巨龜,甲上刻滿上古符文。" },
  { id: "guhuolao", name: "古洞樹妖", element: "火", hp: 231, atk: 16, exp: 500, stones: [96, 190], drops: [{ id: "tianlingguo", chance: 0.5 }, { id: "m_jinlei", chance: 0.02 }, { id: "zhujidan", chance: 0.15 }], desc: "盤踞禁地萬年的妖王,結丹圓滿威壓。" },
  { id: "xuewuzhu", name: "血霧蛛", element: "木", hp: 135, atk: 12, exp: 260, stones: [40, 95], drops: [{ id: "jiaolin", chance: 0.35 }, { id: "qiannianlingru", chance: 0.2 }], desc: "吐血色蛛絲結網的巨蛛,獵物入網頃刻化血。" },
  { id: "kulouwang", name: "枯骨魔將", element: "金", hp: 192, atk: 15, exp: 400, stones: [70, 150], drops: [{ id: "yinsha", chance: 0.5 }, { id: "m_xuantian", chance: 0.02 }], desc: "禁地枯骨凝聚的魔將,執一柄骨矛,刀槍不入。" },
  { id: "chihuoya", name: "赤火鴉群", element: "火", hp: 150, atk: 15, exp: 340, stones: [55, 130], drops: [{ id: "huoyu", chance: 0.5 }, { id: "tianlingguo", chance: 0.25 }], desc: "遮天蔽日的火鴉群,所過之處林木成炭。" },
  // ── 亂星海(元嬰級) ──
  { id: "haimujing", name: "海母巨鯨", element: "水", hp: 539, atk: 34, exp: 940, stones: [180, 410], drops: [{ id: "xuantiehan", chance: 0.4 }, { id: "ziyuanhua", chance: 0.3 }, { id: "haixinzhu", chance: 0.15 }], desc: "吞吐海潮的巨鯨,背上寄生著整座珊瑚島。" },
  { id: "xingchenguai", name: "隕星傀儡", element: "金", hp: 743, atk: 45, exp: 1400, stones: [300, 590], drops: [{ id: "xingchengang", chance: 0.6 }, { id: "m_dageng", chance: 0.02 }], desc: "星宮以隕星之核驅動的戰傀,金光射目。" },
  { id: "wangtianhou", name: "望天吼", element: "木", hp: 1076, atk: 56, exp: 2200, stones: [470, 940], drops: [{ id: "ningyingdan", chance: 0.35 }, { id: "m_aohan", chance: 0.02 }], desc: "仰天長嘯可裂雲海的上古凶獸後裔。" },
  { id: "canghaijiao", name: "滄海蛟龍", element: "水", hp: 674, atk: 39, exp: 1200, stones: [240, 500], drops: [{ id: "jiaolin", chance: 0.4 }, { id: "xuantiehan", chance: 0.3 }], desc: "亂星海深處的蛟龍,捲起千丈狂濤,吞舟裂島。" },
  { id: "jinyuxie", name: "金羽蠍王", element: "金", hp: 896, atk: 51, exp: 1800, stones: [380, 760], drops: [{ id: "xingchengang", chance: 0.45 }, { id: "ziyuanhua", chance: 0.25 }], desc: "披金色甲羽的巨蠍,尾刺一擊可洞穿法器。" },
  { id: "youmingzhang", name: "幽冥章魚", element: "水", hp: 962, atk: 54, exp: 2000, stones: [420, 850], drops: [{ id: "xuantiehan", chance: 0.4 }, { id: "longlinguo", chance: 0.15 }], desc: "萬丈海溝爬出的幽冥巨章,觸手纏繞星辰。" },
  // ── 大晉(化神/煉虛級) ──
  { id: "mohua", name: "魔化修士", element: "火", hp: 2764, atk: 146, exp: 7700, stones: [1400, 3200], drops: [{ id: "mojing", chance: 0.7 }, { id: "m_yuanci", chance: 0.02 }, { id: "m_fentian_liyu", chance: 0.02 }, { id: "moyanjing", chance: 0.15 }, { id: "m_tuhuo_lianxin", chance: 0.02 }, { id: "m_bingjian_shuangsha", chance: 0.02 }], desc: "修煉魔功走火入魔的煉虛修士,神智全失,兇性滔天。" },
  { id: "tianlanyao", name: "天嵐妖鳥", element: "火", hp: 4547, atk: 216, exp: 16000, stones: [2800, 5600], drops: [{ id: "fenghuolin", chance: 0.5 }, { id: "m_sanyan", chance: 0.02 }, { id: "m_jinwu_zhuori", chance: 0.02 }, { id: "m_liulian_shuizhen", chance: 0.02 }, { id: "m_yinfeng_jian", chance: 0.02 }], desc: "風火雙翼遮天蔽日,大晉妖族的圖騰聖獸。" },
  { id: "guimu", name: "鬼母", element: "水", hp: 5242, atk: 277, exp: 22000, stones: [3800, 7500], drops: [{ id: "huangjitiansui", chance: 0.3 }, { id: "dahuandan", chance: 0.5 }, { id: "wanshoudan", chance: 0.08 }, { id: "m_hanyuan_wanli", chance: 0.02 }, { id: "m_yinghuan_shu", chance: 0.02 }, { id: "m_mushui_ronghe", chance: 0.02 }], desc: "陰界裂縫爬出的存在,萬鬼朝拜,煉虛巔峰。" },
  { id: "moxuejun", name: "魔血尊者", element: "火", hp: 3573, atk: 186, exp: 11000, stones: [2000, 4200], drops: [{ id: "mojing", chance: 0.6 }, { id: "longlinguo", chance: 0.2 }, { id: "m_wanteng_tianluo", chance: 0.02 }, { id: "m_ningshen_juli", chance: 0.02 }, { id: "m_dinghun_fu", chance: 0.02 }], desc: "以魔血淬體的煉虛魔修,渾身血氣化甲,力可撼山。" },
  { id: "wuxinbagua", name: "無心霸虎", element: "土", hp: 4162, atk: 242, exp: 14000, stones: [2500, 5000], drops: [{ id: "fenghuolin", chance: 0.4 }, { id: "huangjitiansui", chance: 0.15 }, { id: "m_jinlei_zhui", chance: 0.02 }], desc: "大晉北荒的太古凶虎,雙目無神,只知殺戮。" },
  { id: "youmingfan", name: "幽冥梵僧", element: "金", hp: 4991, atk: 264, exp: 20000, stones: [3400, 6800], drops: [{ id: "mojing", chance: 0.5 }, { id: "dahuandan", chance: 0.4 }], desc: "墮入魔道的佛宗高僧,誦動地獄梵音,攝人心魂。" },
  // ── 靈界(合體/大乘級) ──
  { id: "zhenlingwei", name: "真靈衛", element: "金", hp: 14893, atk: 683, exp: 64000, stones: [3000, 6000], drops: [{ id: "longjinggu", chance: 0.4 }, { id: "m_zhenlong", chance: 0.02 }, { id: "m_canghai_niliu", chance: 0.02 }, { id: "zhenlingsha", chance: 0.12 }, { id: "m_jintu_shuangxiu", chance: 0.02 }, { id: "m_wuxing_sanhe", chance: 0.02 }], desc: "靈界天淵城的傀儡戰衛,真靈血脈驅動。" },
  { id: "gulong", name: "上古真龍殘魂", element: "木", hp: 23320, atk: 933, exp: 150000, stones: [6000, 12000], drops: [{ id: "longjinggu", chance: 0.8 },{id:"nimetanti",chance:0.02}, { id: "pojiedan", chance: 0.25 }, { id: "yanshouguo", chance: 0.1 }, { id: "m_houtu_fengtian", chance: 0.02 }], desc: "隕落真龍不滅的殘魂,一聲龍吟,萬里雲海翻覆。" },
  { id: "tianjie", name: "天劫雷靈", element: "金", hp: 45426, atk: 1817, exp: 490000, stones: [12000, 24000], drops: [{ id: "pojiedan", chance: 0.5 }, { id: "panlongtao", chance: 0.12 }, { id: "m_tianjie_shafa", chance: 0.02 }, { id: "m_huoshui_ni_xiang", chance: 0.02 }, { id: "m_tianyuan_sancai", chance: 0.02 }, { id: "m_jiuyou_lianzhan", chance: 0.02 }], desc: "天劫之中孕生的雷之精靈——渡過它,便是飛昇之門。" },
  { id: "hunyuanshou", name: "混元凶獸", element: "土", hp: 19165, atk: 779, exp: 100000, stones: [4500, 9000], drops: [{ id: "longjinggu", chance: 0.5 }, { id: "huangjitiansui", chance: 0.2 }, { id: "m_shanhe_zhenhun", chance: 0.02 }, { id: "m_wulei_lianji", chance: 0.02 }, { id: "m_xuemai_dazhou", chance: 0.02 }], desc: "靈界洪荒殘留的混元巨獸,一步一頓,山河震顫。" },
  { id: "jiutianfeng", name: "九天玄鳳", element: "火", hp: 31382, atk: 1345, exp: 280000, stones: [9000, 18000], drops: [{ id: "pojiedan", chance: 0.35 }, { id: "huangjitiansui", chance: 0.2 }, { id: "longjinggu", chance: 0.6 }, { id: "m_xuanbing_ci", chance: 0.02 }], desc: "浴火九天的玄色神鳳,一羽焚城,涅槃不滅。" },
  { id: "taixureng", name: "太虛人仙", element: "木", hp: 38237, atk: 1639, exp: 400000, stones: [11000, 22000], drops: [{ id: "pojiedan", chance: 0.45 }, { id: "huangjitiansui", chance: 0.2 }, { id: "yanshouguo", chance: 0.12 }, { id: "m_xuanbing_mieshi", chance: 0.02 }, { id: "m_xuanyin_dun", chance: 0.02 }, { id: "m_poyun_daishi", chance: 0.02 }], desc: "遊走靈界邊緣、拒絕飛昇的太古人仙,一身道行深不可測。" },

  // ── 靈界 · 風元大陸(2.14 版新增,夜叉族夜陽城 / 木靈森林) ──
  { id: "yecha_renwei", name: "夜叉刃衛", element: "木", hp: 15974, atk: 737, exp: 70000, stones: [3200, 6400], drops: [{ id: "fengyuanjing", chance: 0.5 }, { id: "yecha_hunjing", chance: 0.15 }], desc: "夜陽城把守城門的夜叉戰卒,雙刃如風,劈風斬影。" },
  { id: "yehuo_yecha", name: "業火夜叉", element: "火", hp: 20213, atk: 892, exp: 95000, stones: [4000, 8000], drops: [{ id: "fengyuanjing", chance: 0.4 }, { id: "yecha_hunjing", chance: 0.18 }], desc: "渾身業火纏繞的夜叉修士,一觸即焚,性情暴烈。" },
  { id: "yeyang_yaoji", name: "夜陽妖姬", element: "火", hp: 18109, atk: 845, exp: 85000, stones: [3600, 7200], drops: [{ id: "yecha_hunjing", chance: 0.2 }, { id: "fengyuanjing", chance: 0.4 }], desc: "夜陽城中魅惑人心的妖姬,歌聲一出,心神俱迷。" },
  { id: "tengman_yaojing", name: "藤蔓妖精", element: "木", hp: 17046, atk: 761, exp: 75000, stones: [3300, 6600], drops: [{ id: "lingmu_xianye", chance: 0.45 }, { id: "fengyuanjing", chance: 0.2 }], desc: "木靈森林深處的藤蔓精怪,枝蔓纏身,難以掙脫。" },
  { id: "gumu_jingpo", name: "古木精魄", element: "木", hp: 22291, atk: 939, exp: 110000, stones: [4600, 9200], drops: [{ id: "lingmu_xianye", chance: 0.5 }, { id: "huangjitiansui", chance: 0.05 }], desc: "千年古木孕育而生的精魄,軀幹如鐵,一拳千鈞。" },
  { id: "fengling_die", name: "風靈蝶", element: "木", hp: 15435, atk: 710, exp: 65000, stones: [3000, 6000], drops: [{ id: "fengyuanjing", chance: 0.5 }, { id: "lingmu_xianye", chance: 0.25 }], desc: "森林中成群飛舞的異蝶,振翅間風刃四溢。" },

  // ── 靈界 · 雷鳴大陸(2.14 版新增,飛靈族天霄城 / 角蚩族角蠻獄 / 蜉蝣族冥河之地) ──
  { id: "tianxiao_pengwei", name: "天霄鵬衛", element: "金", hp: 33357, atk: 1390, exp: 300000, stones: [9500, 19000], drops: [{ id: "leimingshi", chance: 0.45 }, { id: "jiaochi_tiesui", chance: 0.1 }], desc: "天霄城巡弋的飛靈族鵬衛,展翼刺破雷雲,俯衝之勢無可阻擋。" },
  { id: "jifeng_lingshi", name: "疾風靈使", element: "金", hp: 31382, atk: 1345, exp: 280000, stones: [9000, 18000], drops: [{ id: "leimingshi", chance: 0.5 }], desc: "飛靈族修習疾風秘法的靈使,身法快若閃電。" },
  { id: "xiaohan_jianling", name: "霄漢劍靈", element: "金", hp: 37267, atk: 1480, exp: 330000, stones: [10500, 21000], drops: [{ id: "leimingshi", chance: 0.4 }, { id: "jinleizhu", chance: 0.1 }], desc: "天霄城仙劍所化的劍靈,劍氣縱橫霄漢之間。" },
  { id: "jiaochi_manbing", name: "角蚩蠻兵", element: "金", hp: 35318, atk: 1435, exp: 310000, stones: [10000, 20000], drops: [{ id: "jiaochi_tiesui", chance: 0.45 }, { id: "leimingshi", chance: 0.15 }], desc: "角蠻獄中列陣衝殺的角蚩族蠻兵,頭生雙角,悍不畏死。" },
  { id: "leijiao_mojiang", name: "雷角魔將", element: "金", hp: 42088, atk: 1619, exp: 380000, stones: [12000, 24000], drops: [{ id: "jiaochi_tiesui", chance: 0.5 }, { id: "huangjitiansui", chance: 0.05 }], desc: "角蚩族中悍勇善戰的魔將,雙角蘊雷,一角觸敵雷光爆閃。" },
  { id: "manyu_suohunshi", name: "蠻獄鎖魂使", element: "金", hp: 38237, atk: 1529, exp: 340000, stones: [11000, 22000], drops: [{ id: "jiaochi_tiesui", chance: 0.4 }, { id: "mojing", chance: 0.1 }], desc: "角蠻獄中掌管刑戮的鎖魂使者,鎖鏈一出,魂魄難逃。" },
  { id: "minghe_fuyou", name: "冥河蜉蝣", element: "水", hp: 32371, atk: 1340, exp: 290000, stones: [9200, 18400], drops: [{ id: "minghesha", chance: 0.5 }], desc: "冥河之地成群漂浮的蜉蝣妖蟲,朝生暮死,卻怨氣纏身不散。" },
  { id: "youming_chuanfu", name: "幽冥船夫", element: "水", hp: 39204, atk: 1525, exp: 350000, stones: [11500, 23000], drops: [{ id: "minghesha", chance: 0.45 }, { id: "yinsha", chance: 0.1 }], desc: "擺渡冥河亡魂的蜉蝣族船夫,篙點之處,河水盡皆凝滯。" },
  { id: "wanghun_shiling", name: "亡魂蝕靈", element: "水", hp: 35807, atk: 1432, exp: 320000, stones: [10200, 20400], drops: [{ id: "minghesha", chance: 0.5 }, { id: "mojing", chance: 0.08 }], desc: "冥河沉積怨氣所化的蝕靈,無形無質,專蝕修士神魂。" },

  // ── 靈界 · 血天大陸(2.14 版新增,地血族血獄 / 九龍獄 / 天鼎宮) ──
  { id: "xueyu_xingtu", name: "血獄刑徒", element: "無", hp: 40649, atk: 1572, exp: 360000, stones: [12000, 24000], drops: [{ id: "dixuejing", chance: 0.5 }], desc: "地血族血獄中永世服刑的刑徒,渾身浴血,痛感全無。" },
  { id: "shixue_xiuluo", name: "嗜血修羅", element: "無", hp: 45426, atk: 1764, exp: 420000, stones: [13500, 27000], drops: [{ id: "dixuejing", chance: 0.45 }, { id: "mojing", chance: 0.1 }], desc: "地血族中嗜血成性的修羅,見血愈戰愈勇,近乎瘋狂。" },
  { id: "dixue_moling", name: "地血魔靈", element: "無", hp: 43045, atk: 1668, exp: 390000, stones: [12800, 25600], drops: [{ id: "dixuejing", chance: 0.5 }, { id: "huangjitiansui", chance: 0.06 }], desc: "地血族煉化地脈精血所化的魔靈,踏地而行,血氣沖天。" },
  { id: "longyu_kanshou", name: "龍獄看守", element: "木", hp: 47792, atk: 1859, exp: 460000, stones: [14500, 29000], drops: [{ id: "longyu_linjia", chance: 0.5 }, { id: "longjinggu", chance: 0.1 }], desc: "九龍獄外圍看守的鱗甲妖獸,終年鎮壓獄中凶靈,體魄剛猛。" },
  { id: "suolong_shawei", name: "鎖龍煞衛", element: "木", hp: 50146, atk: 1953, exp: 480000, stones: [15000, 30000], drops: [{ id: "longyu_linjia", chance: 0.45 }, { id: "dixuejing", chance: 0.15 }], desc: "九龍獄深處持鎖鏈巡守的煞衛,一鏈甩出,可鎖蛟縛龍。" },
  { id: "tianding_shouwei", name: "天鼎守衛", element: "金", hp: 65398, atk: 1737, exp: 440000, stones: [14000, 28000], drops: [{ id: "tianding_suipian", chance: 0.5 }, { id: "xutianding", chance: 0.02 }, { id: "jiuding_xiangyun", chance: 0.15 }], desc: "天鼎宮外圍列陣的守衛,渾身鼎紋,鼎氣護體堅不可摧。" },
  { id: "tianding_zhishi", name: "天鼎執事", element: "金", hp: 75345, atk: 1909, exp: 500000, stones: [16000, 32000], drops: [{ id: "tianding_suipian", chance: 0.55 }, { id: "xutianding", chance: 0.03 }, { id: "xuhuangding", chance: 0.012 }, { id: "jiuding_xiangyun", chance: 0.18 }], desc: "天鼎宮中位階更高的執事守衛,掌管鼎火,偶得鼎中至寶餽贈。" },

  // ── 地域王(妖獸領主,極稀有,獵殺時 2%~3% 遭遇;掉落豐厚。1.6 版:靈石掉落一律 ×15) ──
  { id: "lord_tiannan", name: "青元蟒王", element: "木", isLord: true, hp: 193, atk: 8, exp: 230, stones: [1200, 3000], drops: [ { id: "zenglingzhu", chance: 0.35 }, { id: "tianlingguo", chance: 0.8 }, { id: "fu_liehuo", chance: 0.4 }], desc: "盤踞天南千年的蟒中之王,雙目如燈,鱗甲泛青,尋常修士見之膽裂。" },
  { id: "lord_jindi", name: "血獄魔君", element: "火", isLord: true, hp: 913, atk: 58, exp: 3800, stones: [10500, 24000], drops: [ { id: "zenglingzhu", chance: 0.4 }, { id: "qiannianlingru", chance: 0.8 }, { id: "jinganghu", chance: 0.3 }], desc: "血色禁地深處自枯骨中重生的魔頭,渾身血焰,踏過之處寸草不生。" },
  { id: "lord_luanxinghai", name: "萬鱗海皇", element: "水", isLord: true, hp: 5862, atk: 379, exp: 28000, stones: [60000, 120000], drops: [ { id: "zenglingzhu", chance: 0.45 }, { id: "panlongtao", chance: 0.2 }, { id: "ziyuanhua", chance: 0.8 }, { id: "fu_wulei", chance: 0.35 }], desc: "亂星海真正的主宰,一身萬鱗吞吐星光,翻身即掀起滔天巨浪。" },
  { id: "lord_dajin", name: "噬天鬼帝", element: "水", isLord: true, hp: 30389, atk: 1970, exp: 200000, stones: [240000, 480000], drops: [ { id: "zenglingzhu", chance: 0.5 }, { id: "panlongtao", chance: 0.2 }, { id: "huangjitiansui", chance: 0.8 }, { id: "blueprint_xuanyin", chance: 0.25 }], desc: "陰界萬鬼之主,鬼母亦要俯首,一念之間可令大晉一國化為鬼域。" },
  { id: "lord_lingjie", name: "太古龍祖", element: "木", isLord: true, hp: 114767, atk: 6217, exp: 900000, stones: [600000, 1200000], drops: [{ id: "longjinggu", chance: 0.4 },{id:"nimetanti",chance:0.3},{id:"huangjitiansui",chance:0.3}, { id: "zenglingzhu", chance: 0.6 }, { id: "panlongtao", chance: 0.12 }, { id: "pojiedan", chance: 0.9 }, { id: "fu_xuanyin", chance: 0.3 }, { id: "blueprint_xuanyin", chance: 0.3 }, { id: "zhenxiandan", chance: 0.15 }], desc: "靈界所有真龍血脈的源頭,一聲龍吟,天淵城萬里雲海盡數翻覆。" },
  // 九龍獄專屬地域王:曾為真仙,道基崩碎墮落於此,實力遠超同階妖獸,九龍獄看守/鎖龍煞衛偶爾提及其名皆色變
  { id: "duoluo_zhenxian_maliang", name: "墮落真仙馬良", element: "無", isLord: true, hp: 301191, atk: 9466, exp: 2000000, stones: [1200000, 2400000], drops: [{ id: "zhenxiandan", chance: 0.4 }, { id: "xuhuangding", chance: 0.12 }, { id: "xutianding", chance: 0.02 }, { id: "lianshenshu", chance: 0.02 }, { id: "longyu_linjia", chance: 0.6 }, { id: "huangjitiansui", chance: 0.4 }, { id: "zenglingzhu", chance: 0.5 }], desc: "曾位列真仙,卻因心魔入體、道基崩碎而墮落九龍獄的絕世凶靈,一身道行雖已癲狂顛倒,仍遠勝尋常合體大乘妖獸百倍。" },
  ...
  { id: "tianjie_shenling", name: "天劫神靈", element: "金", isLord: true, hp: 261986, atk: 4366, exp: 0, stones: [0, 0], drops: [], desc: "真仙丹引動九霄劫雲所凝的至高劫靈,唯有渡劫者服丹嘗試飛昇時方會現身,考驗其是否有資格白日飛昇。" },

  // ── 北寒仙域(真仙專屬,掉落先天仙器,予以仙靈力;靈石掉落已於 1.6 版兩度調整,現為原區間 ×3) ──
  { id: "bh_hanjiao", name: "玄冰仙蛟", element: "水", hp: 12700, atk: 762, exp: 0, stones: [6000000, 9000000], drops: [{ id: "xiantian_zhong", chance: 0.002 }, { id: "xuanbingjing", chance: 0.1 }], desc: "北寒仙域萬載寒潭孕育的仙蛟,通體晶瑩如玉,一息成冰,已臻仙獸之列。" },
  { id: "bh_binghun", name: "萬載冰魂", element: "水", hp: 18109, atk: 966, exp: 0, stones: [7500000, 10800000], drops: [{ id: "xiantian_zhong", chance: 0.002 }], desc: "玄冰深處凝聚萬載的寒魂,所觸之物盡成永凍,連仙靈力也能封凍。" },
  { id: "bh_hanpeng", name: "極寒天鵬", element: "金", hp: 23320, atk: 1166, exp: 0, stones: [9600000, 13800000], drops: [{ id: "xiantian_zhong", chance: 0.002 }, { id: "xiantian_qi", chance: 0.0075 }, { id: "xuanbingjing", chance: 0.1 }], desc: "展翅蔽日的仙界鵬鳥,雙翼捲動九天寒風,一擊便是萬里冰封。" },
  { id: "bh_xuanwu", name: "北冥玄武", element: "土", hp: 28392, atk: 1249, exp: 0, stones: [12600000, 17400000], drops: [{ id: "xiantian_zhong", chance: 0.002 }, { id: "xiantian_qi", chance: 0.0075 }], desc: "背負仙山的太古玄武,龜甲堅逾仙器,鎮壓北寒一方水土。" },
  { id: "bh_hanlong", name: "寒霜仙龍", element: "金", hp: 35807, atk: 1432, exp: 0, stones: [16200000, 21000000], drops: [{ id: "xiantian_qi", chance: 0.001 },{id:"nimetanti",chance:0.06}, { id: "xiantian_zhong", chance: 0.003 }], desc: "通體覆霜的仙龍,龍息所至冰封千里,乃北寒仙尊麾下的守域仙獸。" },
  // 地域王(北寒仙尊)靈石掉落與其餘六位地域王一併於下方按原始基準 ×15,再套用本次 ×3
  { id: "lord_beihan", name: "北寒仙尊", element: "水", isLord: true, hp: 75345, atk: 1758, exp: 0, stones: [900000, 1800000], drops: [{ id: "tianxiandan", chance: 0.24 },{ id: "zengyuandan", chance: 0.01 }, { id: "xiantian_qi", chance: 0.125 }, { id: "xiantian_zhong", chance: 0.15 }, { id: "m_beiming", chance: 0.2 }], desc: "北寒仙域的無上主宰,一身仙靈力深不見底,傳說祂曾是與天同壽的古仙。天仙丹唯祂身隕方出,更有機緣傳下無上仙法。" },

  // ── 金源仙域(雲遊探索秘境解鎖,強度為北寒 50 倍,五重仙關) ──
  { id: "jy_taiyimang", name: "滄瓓金蟒", element: "金", hp: 1028169, atk: 22848, exp: 0, stones: [2400000, 4800000], drops: [{ id: "jinyuan_suipian", chance: 0.1 }, { id: "jinyuan_shenglian", chance: 0.12 }, { id: "tianxiandan", chance: 0.06 }, { id: "xiantian_qi", chance: 0.0125 }, { id: "xiantian_zaohuadan", chance: 0.006 }, { id: "blueprint_jishen", chance: 0.04 }, { id: "blueprint_xisui", chance: 0.04 }, { id: "xingpan_jin", chance: 0.08 }], desc: "金源仙域第一重仙關的守關凶獸,通體金鱗,吞吐太乙金光。" },
  { id: "jy_huntianyuan", name: "混天靈猿", element: "土", hp: 1640812, atk: 32816, exp: 0, stones: [3300000, 6600000], drops: [{ id: "jinyuan_suipian", chance: 0.1 }, { id: "jinyuan_shenglian", chance: 0.12 }, { id: "tianxiandan", chance: 0.06 }, { id: "jy_hunyuan", chance: 0.03 }, { id: "xiantian_zaohuadan", chance: 0.006 }, { id: "blueprint_hunyuanjia", chance: 0.04 }, { id: "blueprint_ningxian", chance: 0.04 }, { id: "xingpan_mu", chance: 0.08 }], desc: "第二重仙關的洪荒靈猿,雙臂撼動仙山,一吼震碎虛空。" },
  { id: "jy_bahuang", name: "八荒火麒麟", element: "火", hp: 1873373, atk: 46834, exp: 0, stones: [4500000, 9000000], drops: [{ id: "jinyuan_shenglian", chance: 0.12 }, { id: "tianxiandan", chance: 0.065 }, { id: "jy_taiyi", chance: 0.02 }, { id: "xiantian_zaohuadan", chance: 0.006 }, { id: "blueprint_hudao", chance: 0.04 }, { id: "xingpan_huo", chance: 0.08 }, { id: "jinyuan_suipian", chance: 0.1 }], desc: "第三重仙關的火之瑞獸,八荒業火加身,焚盡一切仙靈。" },
  { id: "jy_wujizhu", name: "無極金蛛", element: "金", hp: 2846290, atk: 65951, exp: 0, stones: [6600000, 13200000], drops: [{ id: "jinyuan_shenglian", chance: 0.12 }, { id: "tianxiandan", chance: 0.07 }, { id: "blueprint_taixu", chance: 0.15 }, { id: "xiantian_zaohuadan", chance: 0.006 }, { id: "xingpan_shui", chance: 0.08 }, { id: "jinyuan_suipian", chance: 0.1 }], desc: "第四重仙關的太古金蛛,無極金絲織天羅,仙人亦難掙脫。" },
  // 第五重仙關:金源仙帝身側的兩名護法仙使,實力較仙帝稍弱,守關時與仙帝一同鎮守
  { id: "jy_suijin", name: "金源仙使 - 歲金", element: "金", hp: 2622139, atk: 52443, exp: 0, stones: [6000000, 11400000], drops: [{ id: "jinyuan_suipian", chance: 0.1 }, { id: "jinyuan_shenglian", chance: 0.12 }, { id: "tianxiandan", chance: 0.06 }, { id: "xiantian_qi", chance: 0.02 }, { id: "xiantian_zaohuadan", chance: 0.006 }, { id: "blueprint_zhuxian", chance: 0.05 }, { id: "xingpan_tu", chance: 0.08 }], desc: "第五重仙關的護法仙使,執掌歲月金流,金光流轉間可鎮壓一方時序。" },
  { id: "jy_ruijin", name: "金源仙使 - 銳金", element: "金", hp: 2846290, atk: 59008, exp: 0, stones: [7200000, 12600000], drops: [{ id: "jinyuan_suipian", chance: 0.1 }, { id: "jinyuan_shenglian", chance: 0.12 }, { id: "tianxiandan", chance: 0.06 }, { id: "xiantian_qi", chance: 0.02 }, { id: "xiantian_zaohuadan", chance: 0.006 }, { id: "blueprint_zaohuajian", chance: 0.05 }], desc: "第五重仙關的護法仙使,鋒銳金氣凝形為刃,一擊可裂山斷嶽。" },
  { id: "lord_jinyuan", name: "金源仙帝 - 歐陽白", element: "金", isLord: true, hp: 10862066, atk: 130345, exp: 0, stones: [28000000, 56000000], drops: [{ id: "jinyuan_suipian", chance: 0.1 }, { id: "jinyuan_shenglian", chance: 0.12 }, { id: "tianxiandan", chance: 0.1 },{ id: "zengyuandan", chance: 0.015 }, { id: "blueprint_xisui", chance: 0.04 },{id:"panlongtaoshu",chance:0.3}, { id: "jinhundan", chance: 0.1 }, { id: "fu_taixu", chance: 0.2 }, { id: "pet_hundun", chance: 0.05 }, { id: "m_hunyuan", chance: 0.05 }, { id: "xiantian_zaohuadan", chance: 0.04 }], desc: "金源仙域的無上仙帝,坐鎮第五重仙關,金源之力冠絕仙庭,一指鎮壓億萬里山河。" },

  // ── 雲遊四海際遇 · 金仙境超級大 BOSS(1% 機率遭遇) ──
  { id: "jinxian", name: "太上金仙 · 無極道君", element: "金", isLord: true, hp: 852827, atk: 6202, exp: 0, stones: [400000, 700000], drops: [{ id: "tianxiandan", chance: 0.3 },{ id: "zengyuandan", chance: 0.05 }, { id: "jinhundan", chance: 0.25 }, { id: "xiantian_qi", chance: 0.125 }, { id: "zenglingzhu", chance: 1 }, { id: "m_taiqing", chance: 0.08 }], desc: "傳說中超脫真仙、位列金仙的道君,一縷神念便可鎮壓一域。雲遊四海時萬中無一得見,斬之者必得無上機緣。" },

  // ── 浮屠塔 · 幻象太歲天尊(每層 ×2 強度,無盡挑戰;基準為第 1 層) ──
  { id: "huanxiang_taisui", name: "幻象太歲天尊", element: "土", isLord: true, hp: 222197, atk: 13332, exp: 0, stones: [0, 0], drops: [], desc: "金源仙域浮屠塔中的幻象化身,層層皆是同一尊,卻一層強似一層——每登一層,其力便翻倍,永無止境。傳說登臨絕頂者,可窺見那真正的太歲天尊。" },

  // ── 蠻荒異界(集滿五色異星盤解鎖):攻擊不烈,生命堅韌無匹(金源仙域平均生命力 15 倍) ──
  // 天狐領地
  { id: "chiwei_huyao", name: "赤尾狐妖", element: "火", hp: 22026242, atk: 29368, exp: 0, stones: [8000000, 15000000], drops: [{ id: "manhuang_lingsui", chance: 0.12 }, { id: "tianxiandan", chance: 0.045 }, { id: "xiantian_qi", chance: 0.02 }, { id: "poshou_jinhow", chance: 0.05 }, { id: "xuantian_canpian", chance: 0.05 }, { id: "manhuang_yungu", chance: 0.08 }], desc: "天狐領地的尋常妖狐,赤尾生焰,身法飄忽卻不擅強攻。" },
  { id: "baimei_huxian", name: "白眉狐仙", element: "火", hp: 23387579, atk: 27773, exp: 0, stones: [7500000, 14000000], drops: [{ id: "manhuang_yungu", chance: 0.08 }, { id: "manhuang_lingsui", chance: 0.12 }, { id: "tianxiandan", chance: 0.045 }, { id: "xiantian_qi", chance: 0.02 }, { id: "poshou_jinhow", chance: 0.05 }, { id: "xuantian_canpian", chance: 0.05 }], desc: "天狐領地的修行狐仙,眉生白毫,性狡而不善近戰。" },
  { id: "jiuwei_huxiu", name: "九尾靈狐", element: "木", hp: 26093658, atk: 30443, exp: 0, stones: [8500000, 16000000], drops: [{ id: "manhuang_yungu", chance: 0.08 }, { id: "manhuang_lingsui", chance: 0.12 }, { id: "tianxiandan", chance: 0.045 }, { id: "xiantian_qi", chance: 0.02 }, { id: "poshou_jinhow", chance: 0.05 }, { id: "xuantian_canpian", chance: 0.05 }], desc: "天狐領地修為較深的狐修,九尾初現,靈氣渾厚。" },
  // 真龍領地
  { id: "chilong_wei", name: "螭龍衛", element: "木", hp: 21206551, atk: 35344, exp: 0, stones: [9000000, 17000000], drops: [{ id: "manhuang_yungu", chance: 0.08 }, { id: "manhuang_lingsui", chance: 0.12 }, { id: "tianxiandan", chance: 0.045 },{ id: "longjinggu", chance: 0.3 }, { id: "poshou_jinhow", chance: 0.05 },{id:"nimetanti",chance:0.2}, { id: "xiantian_qi", chance: 0.02 },{id:"longlinguo",chance:0.3}, { id: "xuantian_canpian", chance: 0.05 }], desc: "真龍領地巡守的螭龍,鱗甲堅逾玄鐵,防禦遠勝攻伐。" },
  { id: "youlong_shouwei", name: "蚩龍真靈", element: "木", hp: 20110050, atk: 34010, exp: 0, stones: [8500000, 16000000], drops: [{ id: "manhuang_yungu", chance: 0.08 }, { id: "manhuang_lingsui", chance: 0.12 }, { id: "tianxiandan", chance: 0.045 },{ id: "longjinggu", chance: 0.3 }, { id: "poshou_jinhow", chance: 0.05 },{id:"nimetanti",chance:0.2}, { id: "xiantian_qi", chance: 0.02 },{id:"longlinguo",chance:0.3}, { id: "xuantian_canpian", chance: 0.05 }], desc: "真龍領地初生的幼龍,雖未成年,鱗爪已具龍威。" },
  { id: "longlin_xizu", name: "龍鱗蜥卒", element: "水", hp: 22298981, atk: 36676, exp: 0, stones: [9500000, 18000000], drops: [{ id: "manhuang_yungu", chance: 0.08 }, { id: "manhuang_lingsui", chance: 0.12 }, { id: "tianxiandan", chance: 0.045 },{ id: "longjinggu", chance: 0.3 }, { id: "poshou_jinhow", chance: 0.05 },{id:"nimetanti",chance:0.2}, { id: "xiantian_qi", chance: 0.02 },{id:"longlinguo",chance:0.3}, { id: "xuantian_canpian", chance: 0.05 }], desc: "真龍領地的蜥形卒兵,渾身龍鱗,列陣巡守龍脈。" },
  // 霸下領地
  { id: "shiling_gui", name: "石靈龜", element: "土", hp: 26093658, atk: 26094, exp: 0, stones: [10000000, 19000000], drops: [{ id: "manhuang_yungu", chance: 0.08 }, { id: "manhuang_lingsui", chance: 0.12 }, { id: "tianxiandan", chance: 0.045 }, { id: "xiantian_qi", chance: 0.02 }, { id: "poshou_jinhow", chance: 0.05 }, { id: "xuantian_canpian", chance: 0.05 }], desc: "霸下領地的靈龜,通體石甲,行動遲緩卻幾乎不可摧毀。" },
  { id: "wanshi_kuilei", name: "頑石先鋒", element: "土", hp: 3729716, atk: 27125, exp: 0, stones: [10000000, 19000000], drops: [{ id: "manhuang_yungu", chance: 0.08 }, { id: "manhuang_lingsui", chance: 0.12 }, { id: "tianxiandan", chance: 0.045 }, { id: "xiantian_qi", chance: 0.02 }, { id: "poshou_jinhow", chance: 0.05 }, { id: "xuantian_canpian", chance: 0.05 }], desc: "霸下領地的頑石先鋒,渾身巨岩,行動遲緩、防禦驚人。" },
  { id: "guijia_weishi", name: "厚土玄武", element: "土", hp: 36212829, atk: 26877, exp: 0, stones: [9500000, 18000000], drops: [{ id: "manhuang_yungu", chance: 0.08 }, { id: "manhuang_lingsui", chance: 0.12 }, { id: "tianxiandan", chance: 0.045 }, { id: "xiantian_qi", chance: 0.02 }, { id: "poshou_jinhow", chance: 0.05 }, { id: "xuantian_canpian", chance: 0.05 }], desc: "霸下領地披甲巡守的衛士,龜甲為胄,刀槍難入。" },
  // 貔貅領地
  { id: "chimu_xiuzai", name: "赤目貅", element: "金", hp: 20658825, atk: 32464, exp: 0, stones: [8500000, 16000000], drops: [{ id: "manhuang_yungu", chance: 0.08 }, { id: "manhuang_lingsui", chance: 0.12 }, { id: "tianxiandan", chance: 0.045 }, { id: "xiantian_qi", chance: 0.02 }, { id: "poshou_jinhow", chance: 0.05 }, { id: "xuantian_canpian", chance: 0.05 }], desc: "貔貅領地的幼貅,雙目赤紅,貪食靈氣,皮糙肉厚。" },
  { id: "jubao_xiushou", name: "聚寶貅獸", element: "金", hp: 20110050, atk: 31052, exp: 0, stones: [9000000, 17000000], drops: [{ id: "manhuang_yungu", chance: 0.08 }, { id: "manhuang_lingsui", chance: 0.12 }, { id: "tianxiandan", chance: 0.045 }, { id: "xiantian_qi", chance: 0.02 }, { id: "poshou_jinhow", chance: 0.05 }, { id: "xuantian_canpian", chance: 0.05 }], desc: "貔貅領地嗜財的貅獸,渾身金氣,遇寶必吞。" },
  { id: "yinzhua_xiuwei", name: "銀爪貅衛", element: "金", hp: 21480030, atk: 33838, exp: 0, stones: [9000000, 17000000], drops: [{ id: "manhuang_yungu", chance: 0.08 }, { id: "manhuang_lingsui", chance: 0.12 }, { id: "tianxiandan", chance: 0.045 }, { id: "xiantian_qi", chance: 0.02 }, { id: "poshou_jinhow", chance: 0.05 }, { id: "xuantian_canpian", chance: 0.05 }], desc: "貔貅領地的護衛貅獸,雙爪泛銀,守衛領地寶藏。" },

  // 蠻荒四大地域王(獵殺時 3%~5% 遭遇),各具專屬異能
  { id: "lord_tianhu", name: "天狐", element: "火", isLord: true, hp: 101175344, atk: 39419, exp: 0, stones: [300000000, 600000000], drops: [{ id: "manhuang_lingsui", chance: 0.12 }, { id: "zengyuandan", chance: 0.06 }, { id: "xiantian_qi", chance: 0.2 }, { id: "thantian_lu", chance: 0.0375 }, { id: "poshou_jinhow", chance: 0.5 },{id:"panlongtaoshu",chance:0.3}, { id: "zenglingzhu", chance: 0.5 }, { id: "tianxiandan", chance: 0.09 }, { id: "taiyi_jinghun_tianhu", chance: 0.12 }, { id: "xuantian_canpian", chance: 0.3 }, { id: "m_jiuxiao_leihuo", chance: 0.02 }], desc: "天狐領地之主,身法通神,戰時有三成機率身形一晃、憑空避過攻擊。" },
  { id: "lord_zhenlong", name: "真龍", element: "木", isLord: true, hp: 119497474, atk: 46760, exp: 0, stones: [300000000, 600000000], drops: [{ id: "manhuang_lingsui", chance: 0.12 }, { id: "zengyuandan", chance: 0.06 }, { id: "jinhundan", chance: 0.03 }, { id: "thantian_lu", chance: 0.0375 }, { id: "poshou_jinhow", chance: 0.5 },{id:"panlongtaoshu",chance:0.3}, { id: "xiantian_qi", chance: 0.125 }, { id: "zenglingzhu", chance: 0.5 }, { id: "tianxiandan", chance: 0.09 }, { id: "taiyi_jinghun_zhenlong", chance: 0.12 }, { id: "xuantian_canpian", chance: 0.35 }], desc: "真龍領地之主,龍血偶爾狂暴,兩成機率一擊爆發三倍攻擊之力。" },
  { id: "lord_baxia", name: "霸下", element: "土", isLord: true, hp: 1333333333, atk: 12222, exp: 0, stones: [400000000, 800000000], drops: [{ id: "manhuang_lingsui", chance: 0.12 }, { id: "zengyuandan", chance: 0.06 },{id:"nimetanti",chance:0.8}, { id: "thantian_lu", chance: 0.045 }, { id: "xiantian_qi", chance: 0.15 },{id:"panlongtaoshu",chance:0.3}, { id: "zenglingzhu", chance: 0.5 }, { id: "tianxiandan", chance: 0.1 }, { id: "taiyi_jinghun_baxia", chance: 0.12 }, { id: "xuantian_canpian", chance: 0.35 }], desc: "霸下領地之主,龍生九子之一,以馱負洪荒著稱——氣血堅韌至極,乃尋常妖獸的四十倍。" },
  { id: "lord_pixiu", name: "黑眼貔貅", element: "金", isLord: true, hp: 10862066, atk: 12414, exp: 0, stones: [300000000, 600000000], drops: [{ id: "qiankun_dai", chance: 0.08 }, { id: "manhuang_lingsui", chance: 0.12 }, { id: "zengyuandan", chance: 0.06 }, { id: "xiantian_qi", chance: 0.2 }, { id: "thantian_lu", chance: 0.0375 }, { id: "poshou_jinhow", chance: 0.5 },{id:"panlongtaoshu",chance:0.3}, { id: "zenglingzhu", chance: 0.5 }, { id: "tianxiandan", chance: 0.09 }, { id: "taiyi_jinghun_pixiu", chance: 0.12 }, { id: "xuantian_canpian", chance: 0.35 }], desc: "貔貅領地之主,雙目幽黑,戰時可封鎖敵人法力波動,令其法術盡數失效,唯有以法器相搏。" },
];
